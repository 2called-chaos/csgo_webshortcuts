...
// URL convar to override compile time constant
ConVar gc_motdfixURL;
...
{
  gc_motdfixURL = CreateConVar("sm_csgo_motdfix_url", CSGO_MOTDFIX_URL, "Full URL to your hosted ws.html");
